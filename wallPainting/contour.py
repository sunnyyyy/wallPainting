...
def main():
    ...
    labels_path = f"/Users/Sunny/Downloads/converted_keras/labels.txt"
    ...
    model_path = f"/Users/Sunny/Downloads/converted_keras/keras_model.h5"
    ...
    while True:
        ...
        for i in range(0, len(classes)):
            ...
            if threshold_class== "Analyse" :
                     ## RESIZE IMAGE
                     # scale in percentage
                     # resize image
                     # Convert the grayscale image to binary
                     ret, binary = cv2.threshold(grayImage, 100, 255, cv2.THRESH_OTSU)
